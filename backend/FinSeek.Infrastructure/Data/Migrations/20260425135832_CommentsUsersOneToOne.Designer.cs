...
namespace FinSeek.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260425135832_CommentsUsersOneToOne")]
    partial class CommentsUsersOneToOne
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinSeek.Domain.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "9b8be70d-05ee-414c-99e6-4b8a16d48555",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "53c342ec-22f2-4a91-a801-542b44e2e85d",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinSeek.Domain.Entities.AppUser", null)
                        .WithMany()
